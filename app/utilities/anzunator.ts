...
export const questions: Question[] = [
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Does this character have long hair?",
        "long_hair",
        true,
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Does this character wear glasses?",
        "glasses",
        true,
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Does this character have a beauty mark?",
        "beauty_mark",
        true,
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Does this character have streaks in their hair?",
        "multi_hair",
        true,
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Is this character a part of StarPro?",
        "agency",
        "starpro",
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Is this character a part of CosPro?",
        "agency",
        "cospro",
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Is this character a part of RhythLink?",
        "agency",
        "rhylin",
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Is this character a part of NewDi?",
        "agency",
        "newdi",
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Has this character ever been to Yumenosaki Academy?",
        "school",
        "Yumenosaki",
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Has this character ever been to Reimei Academy?",
        "school",
        "Reimei",
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    noEffect: (
      ...
      noEffect(
        "Has this character ever been to Shuuetsu Academy?",
        "school",
        "Shuuetsu",
        questionArr,
        setQuestions,
  ...
  },
  {
    ...
    yesEffect: (
      ...
      circleYesEffect(
        circleQuestion("Mystery Researchers"),
        setQuestions,
        questionArr,
        "mystery",
        idols,
  ...
  },
  {
    ...
    yesEffect: (
      ...
      circleYesEffect(
        circleQuestion("Overnight Outdoors Party"),
        setQuestions,
        questionArr,
        "overnight",
        idols,
  ...
  },
  {
    ...
    yesEffect: (
      ...
      circleYesEffect(
        circleQuestion("Sports Survivors"),
        setQuestions,
        questionArr,
        "sports",
        idols,
  ...
  },
  {
    ...
    yesEffect: (
      ...
      circleYesEffect(
        circleQuestion("Sweets Fan Club"),
        setQuestions,
        questionArr,
        "sweets",
        idols,
  ...
  },
  {
    ...
    noEffect: (
      ...
      setQuestions(
        questionArr.filter(
          (q) => q.question !== "Is this character 165cm or shorter?",
        ),
      );
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("January")),
      );
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("February")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("March")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("April")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("May")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("June")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("July")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("August")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("September")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("October")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("November")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
  ...
  },
  {
    ...
    noEffect: (
      ...
      // remove this question
      setQuestions(
        questionArr.filter((q) => q.question !== monthQuestion("December")),
      );
      // remove idols that are born in that month
      setCharas(
        idols.filter((i) => {
...
export const ANZU_REGULAR =
  "https://assets.hellogirls.info/misc/anzu_talking.png";
export const ANZU_THINKING =
  "https://assets.hellogirls.info/misc/anzu_thinking.png";
export const ANZU_OH = "https://assets.hellogirls.info/misc/anzu_oh.png";
export const ANZU_EXCITED =
  "https://assets.hellogirls.info/misc/anzu_excited.png";
